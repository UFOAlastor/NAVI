...
const translations = {
  'zh': {
    ...
    'ignoreLinks': '忽略链接',
    'ignoreLinksDescription': '启用后，划选URL、邮箱、路径等格式时不触发解释',
    'showDomain': '显示领域',
    'showDomainDescription': '启用后，AI回答中将包含对文本所属专业领域的分析',
    'selectionDelay': '划词延时',
    'msUnit': '毫秒',
    ...
    'primaryLangBehavior': '主选语言处理方式：',
    'primaryLangBehavior_auto': '自动翻译解释 (默认)',
    'primaryLangBehavior_button': '显示触发按钮',
    'primaryLangBehavior_disable': '关闭',
    'primaryLangBehaviorTip': '选择当文本包含主选语言时的处理方式',
    'primaryLangBehaviorDescription': '选择当文本包含主选语言时的处理方式',
    'secondaryTargetLanguageDescription': '当检测到文本是主选语言时，将翻译成次选语言',
    'apiKey': 'API密钥',
  ...
  'en': {
    ...
    'ignoreLinksDescription': 'When enabled, selecting URLs, email addresses, file paths and other formats will not trigger explanation',
    'showDomain': 'Show Domain',
    'showDomainDescription': 'When enabled, AI responses will include analysis of the text\'s professional domain',
    ...
    'primaryLangBehavior': 'Primary Language Behavior:',
    'primaryLangBehavior_auto': 'Auto Translate & Explain (Default)',
    'primaryLangBehavior_button': 'Show Trigger Button',
    'primaryLangBehavior_disable': 'Disable',
    'primaryLangBehaviorTip': 'Choose how to handle text containing your primary language',
    'primaryLangBehaviorDescription': 'Choose how to handle text containing your primary language',
    'secondaryTargetLanguageDescription': 'When text is detected to be in your primary language, it will be translated to the secondary language',
    'apiKey': 'API Key',
